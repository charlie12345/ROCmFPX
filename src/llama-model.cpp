        ...
        default:
            {
                ...
                if (llm_arch_is_recurrent(arch)) {
                    ...
                    } else if (arch == LLM_ARCH_QWEN35 || arch == LLM_ARCH_QWEN35MOE || arch == LLM_ARCH_BAILINGMOE3 || arch == LLM_ARCH_QWEN4EXP) { // qwen4exp joins this branch: n_main covers main layers (nextn excluded)

...
**1. Model.** A ROCmFP4 GGUF of Qwen3.8-27B that includes the MTP head
(`MQ-Q4`, ~14.6 GB), plus the f16 `mmproj` for vision. For better quality at
the same speed and VRAM, build the
[MQ-Q4S variant](docs/rocmfpx/swift-qwen3.8-27b-mq-q4s.md), which promotes 61
sensitive tensors to `Q6_0_ROCMFPX` (wikitext-2 perplexity 7.107 vs 7.143); the
recipe and its tensor policy file are in this repository.
